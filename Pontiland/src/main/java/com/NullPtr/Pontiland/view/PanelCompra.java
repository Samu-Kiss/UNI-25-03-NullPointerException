...
/**
 * Clase: PanelCompra Propósito: Vista presentacional del panel de compra. No contiene lógica de
 * juego y no llama repos/servicios. El Servicio la invoca mediante IPanelCompraView.
 */
public class PanelCompra implements IPanelCompra {
  ...
  /**
   * Firma: PanelCompra(Node rootGui) Propósito: Construir el panel en estado oculto. Parámetros: -
   * rootGui: nodo GUI raíz (guiNode) Retorno: N/A
   */
  ...
  /**
   * Firma: setController(HudController controller) Propósito: Inyectar el controlador a quien se
   * reportan los clicks del usuario. Parámetros: - controller: controlador HUD Retorno: void
   */
  ...
  /**
   * Firma: construirUI() Propósito: Crear y organizar widgets Lemur. Reenviar eventos →
   * controlador. Parámetros: N/A Retorno: void
   */
