 ...
 *
 * Esta clase no extiende {@link SimpleApplication}; en su lugar, recibe una
 * referencia a una instancia de SimpleApplication y a un estado de físicas
 * para poder cargar modelos, luces y cámara. Además, inyecta el dado
 * creado en la escena en el {@link DiceService} para permitir su lógica.
 */
public class Scene {
    ...
    /**
     * Método de actualización por frame. Actualmente no realiza ninguna acción,
     * pero queda disponible para animaciones o actualizaciones de la escena.
     *
    ...
    /**
     * Carga dos modelos de dados, crea sus cuerpos físicos y los inyecta en el servicio.
     * Se activan funciones de detección de colisión continua (CCD) para evitar que
     * atraviesen otros objetos cuando ruedan a gran velocidad.
     */
