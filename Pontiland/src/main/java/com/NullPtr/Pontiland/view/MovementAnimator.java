...
public class MovementAnimator {
    ...
    public MovementAnimator(LanzamientoDadosController lanzamientoController, CameraController cameraController) {
    ...
    public void animateMoveAlongPath(Spatial s, RigidBodyControl rb, List<Vector3f> targets, List<Integer> indices, float durationSeconds, float jumpHeight) {
        this.mvSpatial = s;
        this.mvRb = rb;
        ...
        Vector3f start = (rb != null && rb.getPhysicsLocation() != null) ? rb.getPhysicsLocation() : s.getLocalTranslation();
