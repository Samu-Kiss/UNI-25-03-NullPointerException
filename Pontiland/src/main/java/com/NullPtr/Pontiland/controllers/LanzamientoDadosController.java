...
/**
 * Controlador encargado de registrar entradas y orquestar el servicio de dados.
 * No extiende AppState; expone registerInputs(...) y update(tpf).
 */
public class LanzamientoDadosController {
    private final DiceService diceService;
    private final AtomicReferenceArray<Byte> resultados;
    /**
     * Listener de acciones para gestionar las teclas de control del dado.
     * Se registra en el InputManager a través de {@link #registerInputs(InputManager)}.
     */
    private final RawInputListener rawKeys = new RawInputListener() {
        @Override
    ...
    public LanzamientoDadosController(DiceService diceService,
                                      AtomicReferenceArray<Byte> resultados) {
