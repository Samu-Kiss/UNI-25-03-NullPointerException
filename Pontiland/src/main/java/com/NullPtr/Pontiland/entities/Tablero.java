...
/**
 * Representa el tablero del juego, compuesto por una lista de casillas. Cada casilla puede ser una
 * propiedad, una estación, un evento, etc.
 */
public class Tablero {
  // WARNING: La lista a nivel de programación está con indexación 0, pero en el juego la casilla 1
  // es la primera.
