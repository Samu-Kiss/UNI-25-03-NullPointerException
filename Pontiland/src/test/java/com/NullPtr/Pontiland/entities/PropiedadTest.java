...
class PropiedadTest {
  ...
  void validConstructorTest() {
    ...
    assertNull(
        propiedad.getNombreCasilla(), "El nombre de la casilla no se asigna en el constructor");
  }
  ...
  void validSetIdPropiedadTest() {
    ...
    assertEquals(
        24, propiedad.getIdPropiedad(), "El idPropiedad debe aceptar el valor máximo permitido");
  }
